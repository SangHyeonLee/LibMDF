...
void main() {
	...
	//label_imageProcessing::print_page_slot(DB_name.c_str());

	//label_imageProcessing::page_to_lmdb(DB_name.c_str(), destPath.c_str());
	label_imageProcessing::testLMDB(DB_name.c_str(), destPath.c_str());
	puts("end main");
